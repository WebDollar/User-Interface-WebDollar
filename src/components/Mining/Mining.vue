    ...
    <div id="dashboardMining" class="walletSection" >
        ...
        <div id="minningController">
            ...
            <div id="miningDetails">
                <p class="" :style="{display: this.hashesPerSecond==0 && this.started==true ? 'none' : 'inline-block'}">{{this.started ? ( this.isPoSActivated ? 'Staking...' : this.hashesPerSecond + ' hash/sec') : 'not started'}} </p>
    ...
    export default{
        ...
        methods: {
            ...
            isPoSActivated(){
                ...
                return WebDollar.Blockchain.blockchainGenesis.isPoSActivated( WebDollar.Blockchain.blockchain.block.length-1 )
