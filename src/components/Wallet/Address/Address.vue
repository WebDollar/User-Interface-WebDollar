...
.walletAddress:hover .walletReceivingImg,
.walletAddress:hover .walletSendingImg {
    display: none;
}
...
export default {
    ...
    components: {
        AddressMainModal, LockModal, DeleteModal, ShowBalance, icon
    },
    ...
    methods: {
        ...
        async handleExport(e) {
            ...
            if (this.addressLocked === false) {
                Notification.addAlert(undefined, "info", "Export Warning", "The exported wallet is not encrypted. Due to safety reasons it is recommended to encrypt your wallet.", 20000);
            }
            ...
            if (answer.result) {
                ...
                let addressFile = new Blob([JSON.stringify(answer.data)], {
                ...
                Notification.addAlert(undefined, "success", "Succesful Export", "Your address has been exported.", 5000);
